...
const getHighTraffic = async (req, res) => {
  ...
  console.log("Found " + reservedTables.length + " tables reserved");
  const isHighTrafficDay = reservedTables.length > 3;
  if (isHighTrafficDay) {
...
const createReservation = async (req, res) => {
  ...
  try {
    ...
    const isHighTrafficDay = reservedTableIds.length > 3;
